# Graph Report - atomix-mds  (2026-08-21)

## Corpus Check
- 87 files · ~139,305 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 888 nodes · 1620 edges · 78 communities (64 shown, 14 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 36 edges (avg confidence: 0.56)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `165fa175`
...
- `claimExecute()` --indirect_call--> `tok()`  [INFERRED]
  lib/otc.js → lib/ui.js
...
## Knowledge Gaps
- **88 isolated node(s):** `Shell`, `Swap tab`, `Wallet tab`, `Activity tab`, `Market tab` (+83 more)
