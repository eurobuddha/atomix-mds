# Graph Report - atomix-mds  (2026-08-16)

## Corpus Check
- 87 files · ~138,458 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 884 nodes · 1604 edges · 78 communities (64 shown, 14 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 36 edges (avg confidence: 0.56)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `158ff0b1`
...
- `"node_modules/blakejs/util.js"()` --indirect_call--> `toHex()`  [INFERRED]
  vendor/blake.js → lib/hex.js
...
### Community 9 - "htlc.js"
Cohesion: 0.16
Nodes (21): claim(), coinAmount(), deleteTxn(), grain(), loadKeys(), lock(), lockFromCoins(), maybeGrain() (+13 more)
...
## Knowledge Gaps
- **88 isolated node(s):** `install.sh script`, `Versioning guardrail — every code change ships with a version bump`, `Shell`, `Swap tab`, `Wallet tab` (+83 more)
...
- **What connects `install.sh script`, `Versioning guardrail — every code change ships with a version bump`, `Shell` to the rest of the system?**
