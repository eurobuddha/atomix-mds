# Graph Report - atomix-mds  (2026-08-24)

## Corpus Check
- 87 files · ~139,816 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 890 nodes · 1625 edges · 78 communities (64 shown, 14 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 35 edges (avg confidence: 0.55)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `71057376`
...
- `fromSeed()` --references--> `S`  [EXTRACTED]
  lib/identity.js → spike/verify_rhino.js
