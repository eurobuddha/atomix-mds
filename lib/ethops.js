...
(function (g) {
    ...
    function make(rpc, privHex, address) {
        ...
        return {
            ...
            /** allowance(owner=me, htlc) — cb(err, BigInt). */
            allowance: function (token, cb) {
                var call = EH.allowance(address);
                rpc.ethCall(token, call.data, function (e, ret) { cb(e, e ? 0n : AX.ethrpc.hexToBig(ret)); });
            },
            ...
            balanceOf: function (token, cb) {
                ...
                rpc.ethCall(token, data, function (e, ret) { cb(e, e ? 0n : AX.ethrpc.hexToBig(ret)); });
            },
