...
(function (g) {
    ...
    var S = {
        ...
        bals: { minima: '0', usdt: '0', eth: '0' }, swaps: [], oracle: '', status: '', paired: true
    };
    var TABS = [
    ...
    function banner() {
        var b = el('div', { id: 'pairbanner' + (S.paired ? '' : ' show'), text: 'Enable AtomiX in Minima Core → Apps to connect to your node.' });
        b.id = 'pairbanner'; if (!S.paired) b.className = 'show'; return b;
    }
