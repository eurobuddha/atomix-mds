...
(function (g) {
    ...
    function addIncoming(hash) { if (hash) incoming[normHash(hash)] = hash; }
    ...
    function scanIncomingBuys(block, next) {
        ...
        // OTC buy-takes arrive as queued `incoming` hashes (from EXECUTE) and are processed regardless of a ladder.
